...
package com.goteny.melo.utils.cglibAndroid.dx.dex.file;

import com.goteny.melo.utils.cglibAndroid.dx.dex.code.DalvCode;
import com.goteny.melo.utils.cglibAndroid.dx.dex.code.DalvInsnList;
import com.goteny.melo.utils.cglibAndroid.dx.dex.code.LocalList;
import com.goteny.melo.utils.cglibAndroid.dx.dex.code.PositionList;
import com.goteny.melo.utils.cglibAndroid.dx.rop.cst.CstMethodRef;
import com.goteny.melo.utils.cglibAndroid.dx.rop.cst.CstString;
import com.goteny.melo.utils.cglibAndroid.dx.rop.type.Prototype;
import com.goteny.melo.utils.cglibAndroid.dx.rop.type.StdTypeList;
import com.goteny.melo.utils.cglibAndroid.dx.rop.type.Type;
import com.goteny.melo.utils.cglibAndroid.dx.util.ByteArrayByteInput;
import com.goteny.melo.utils.cglibAndroid.dx.util.ByteInput;
import com.goteny.melo.utils.cglibAndroid.dx.util.ExceptionWithContext;
import com.goteny.melo.utils.cglibAndroid.dx.util.Leb128Utils;

import java.io.IOException;
import java.util.ArrayList;
import java.util.List;

import static com.goteny.melo.utils.cglibAndroid.dx.dex.file.DebugInfoConstants.DBG_ADVANCE_LINE;
import static com.goteny.melo.utils.cglibAndroid.dx.dex.file.DebugInfoConstants.DBG_ADVANCE_PC;
import static com.goteny.melo.utils.cglibAndroid.dx.dex.file.DebugInfoConstants.DBG_END_LOCAL;
import static com.goteny.melo.utils.cglibAndroid.dx.dex.file.DebugInfoConstants.DBG_END_SEQUENCE;
import static com.goteny.melo.utils.cglibAndroid.dx.dex.file.DebugInfoConstants.DBG_FIRST_SPECIAL;
import static com.goteny.melo.utils.cglibAndroid.dx.dex.file.DebugInfoConstants.DBG_LINE_BASE;
import static com.goteny.melo.utils.cglibAndroid.dx.dex.file.DebugInfoConstants.DBG_LINE_RANGE;
import static com.goteny.melo.utils.cglibAndroid.dx.dex.file.DebugInfoConstants.DBG_RESTART_LOCAL;
import static com.goteny.melo.utils.cglibAndroid.dx.dex.file.DebugInfoConstants.DBG_SET_EPILOGUE_BEGIN;
import static com.goteny.melo.utils.cglibAndroid.dx.dex.file.DebugInfoConstants.DBG_SET_FILE;
import static com.goteny.melo.utils.cglibAndroid.dx.dex.file.DebugInfoConstants.DBG_SET_PROLOGUE_END;
import static com.goteny.melo.utils.cglibAndroid.dx.dex.file.DebugInfoConstants.DBG_START_LOCAL;
import static com.goteny.melo.utils.cglibAndroid.dx.dex.file.DebugInfoConstants.DBG_START_LOCAL_EXTENDED;
