...
package com.goteny.melo.utils.cglibAndroid.dx;
...
public final class TypeId<T> {
    ...
    public static final TypeId<Boolean> BOOLEAN
            = new TypeId<Boolean>(com.goteny.melo.utils.cglibAndroid.dx.rop.type.Type.BOOLEAN);

    /** The {@code byte} primitive type. */
    public static final TypeId<Byte> BYTE = new TypeId<Byte>(com.goteny.melo.utils.cglibAndroid.dx.rop.type.Type.BYTE);

    /** The {@code char} primitive type. */
    public static final TypeId<Character> CHAR
            = new TypeId<Character>(com.goteny.melo.utils.cglibAndroid.dx.rop.type.Type.CHAR);

    /** The {@code double} primitive type. */
    public static final TypeId<Double> DOUBLE = new TypeId<Double>(com.goteny.melo.utils.cglibAndroid.dx.rop.type.Type.DOUBLE);

    /** The {@code float} primitive type. */
    public static final TypeId<Float> FLOAT = new TypeId<Float>(com.goteny.melo.utils.cglibAndroid.dx.rop.type.Type.FLOAT);

    /** The {@code int} primitive type. */
    public static final TypeId<Integer> INT = new TypeId<Integer>(com.goteny.melo.utils.cglibAndroid.dx.rop.type.Type.INT);

    /** The {@code long} primitive type. */
    public static final TypeId<Long> LONG = new TypeId<Long>(com.goteny.melo.utils.cglibAndroid.dx.rop.type.Type.LONG);

    /** The {@code short} primitive type. */
    public static final TypeId<Short> SHORT = new TypeId<Short>(com.goteny.melo.utils.cglibAndroid.dx.rop.type.Type.SHORT);

    /** The {@code void} primitive type. Only used as a return type. */
    public static final TypeId<Void> VOID = new TypeId<Void>(com.goteny.melo.utils.cglibAndroid.dx.rop.type.Type.VOID);

    /** The {@code Object} type. */
    public static final TypeId<Object> OBJECT = new TypeId<Object>(com.goteny.melo.utils.cglibAndroid.dx.rop.type.Type.OBJECT);

    /** The {@code String} type. */
    public static final TypeId<String> STRING = new TypeId<String>(com.goteny.melo.utils.cglibAndroid.dx.rop.type.Type.STRING);
    ...
    final com.goteny.melo.utils.cglibAndroid.dx.rop.type.Type ropType;
    final CstType constant;

    TypeId(com.goteny.melo.utils.cglibAndroid.dx.rop.type.Type ropType) {
        this(ropType.getDescriptor(), ropType);
    }

    TypeId(String name, com.goteny.melo.utils.cglibAndroid.dx.rop.type.Type ropType) {
    ...
    public static <T> TypeId<T> get(String name) {
        return new TypeId<T>(name, com.goteny.melo.utils.cglibAndroid.dx.rop.type.Type.internReturnType(name));
    }
