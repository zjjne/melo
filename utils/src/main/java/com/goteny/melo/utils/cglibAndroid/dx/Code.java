...
import static com.goteny.melo.utils.cglibAndroid.dx.rop.code.Rop.BRANCH_GOTO;
import static com.goteny.melo.utils.cglibAndroid.dx.rop.code.Rop.BRANCH_NONE;
import static com.goteny.melo.utils.cglibAndroid.dx.rop.code.Rop.BRANCH_RETURN;
import static com.goteny.melo.utils.cglibAndroid.dx.rop.type.Type.BT_BYTE;
import static com.goteny.melo.utils.cglibAndroid.dx.rop.type.Type.BT_CHAR;
import static com.goteny.melo.utils.cglibAndroid.dx.rop.type.Type.BT_INT;
import static com.goteny.melo.utils.cglibAndroid.dx.rop.type.Type.BT_SHORT;
...
public final class Code {
   ...
   public <D, V> void iput(FieldId<D, V> fieldId, Local<D> instance, Local<V> source) {
    ...
    private Rop getCastRop(com.goteny.melo.utils.cglibAndroid.dx.rop.type.Type sourceType,
                           com.goteny.melo.utils.cglibAndroid.dx.rop.type.Type targetType) {
