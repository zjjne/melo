...
import com.goteny.melo.utils.cglibAndroid.dx.rop.code.BasicBlock;
import com.goteny.melo.utils.cglibAndroid.dx.rop.code.BasicBlockList;
import com.goteny.melo.utils.cglibAndroid.dx.rop.code.FillArrayDataInsn;
import com.goteny.melo.utils.cglibAndroid.dx.rop.code.Insn;
import com.goteny.melo.utils.cglibAndroid.dx.rop.code.LocalVariableInfo;
import com.goteny.melo.utils.cglibAndroid.dx.rop.code.PlainCstInsn;
import com.goteny.melo.utils.cglibAndroid.dx.rop.code.PlainInsn;
import com.goteny.melo.utils.cglibAndroid.dx.rop.code.RegOps;
import com.goteny.melo.utils.cglibAndroid.dx.rop.code.RegisterSpec;
import com.goteny.melo.utils.cglibAndroid.dx.rop.code.RegisterSpecList;
import com.goteny.melo.utils.cglibAndroid.dx.rop.code.RegisterSpecSet;
import com.goteny.melo.utils.cglibAndroid.dx.rop.code.Rop;
import com.goteny.melo.utils.cglibAndroid.dx.rop.code.RopMethod;
import com.goteny.melo.utils.cglibAndroid.dx.rop.code.SourcePosition;
import com.goteny.melo.utils.cglibAndroid.dx.rop.code.SwitchInsn;
import com.goteny.melo.utils.cglibAndroid.dx.rop.code.ThrowingCstInsn;
import com.goteny.melo.utils.cglibAndroid.dx.rop.code.ThrowingInsn;
import com.goteny.melo.utils.cglibAndroid.dx.rop.cst.Constant;
import com.goteny.melo.utils.cglibAndroid.dx.rop.cst.CstInteger;
import com.goteny.melo.utils.cglibAndroid.dx.util.Bits;
import com.goteny.melo.utils.cglibAndroid.dx.util.IntList;
